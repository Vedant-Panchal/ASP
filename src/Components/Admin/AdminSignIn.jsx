          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                >
                  <div >
                  <Eye className='dark:text-slate-200 text-zinc-900'strokeWidth={1.25} hidden={eye} />
                  <EyeOff className='dark:text-slate-200 text-zinc-900'strokeWidth={1.25}  hidden={!eye}/>
                  </div>
                </button>
                  </div>
              </div>
