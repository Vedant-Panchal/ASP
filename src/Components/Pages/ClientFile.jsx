...
function ClientFile({ file }) {
  ...
  return (
    <Link
      ...
      target='_blank'
      className='relative rounded-lg dark:bg-darkElevate dark:hover:bg-darkElevate/90 h-fit md:h-20 shadow-lg bg-lightElevate hover:bg-lightElevateHover transition-all duration-200 ease-in hover:scale-[1.03] dark:shadow-lg dark:shadow-neutral-900 flex items-center justify-start p-4'
