...
function Dashboard() {
  ...
  return (
    <div className="antialiased bg-gray-50 dark:bg-gray-900">
      ...
      {/* Sidebar */}
      <aside className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r shadow-lg shadow-slate-700/80 border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
